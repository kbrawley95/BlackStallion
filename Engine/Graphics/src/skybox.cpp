Skybox::Skybox(std::string name, std::vector<std::string>texturePaths, std::vector<GLenum>textureTargets) : GameObject(name)
{
...
GLuint Skybox::loadCubeMap(std::vector<std::string>texturePaths, std::vector<GLenum>textureTargets)
{
    std::cout<<std::endl;
...
void Skybox::bindCubemapToPipeline(GLuint textureID)
{
